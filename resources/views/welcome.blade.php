        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="https://github.com/impruthvi/flexboard-bytes" target="_blank" class="nav-link-neon flex items-center gap-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up" style="animation-delay: 0.2s;">
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn-neon btn-neon-pink text-lg py-3 px-8">
    ...
    <section id="branches" class="py-24 bg-mesh relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                @php
                    $branches = [
                        ['num' => '01', 'name' => 'Model Conventions', 'desc' => 'Naming, tables, keys', 'color' => 'cyan'],
                        ['num' => '02', 'name' => 'Mass Assignment', 'desc' => '$fillable & $guarded', 'color' => 'pink'],
                        ['num' => '03', 'name' => 'Accessors & Mutators', 'desc' => 'casts() & Attribute', 'color' => 'purple'],
                        ['num' => '04', 'name' => 'Query Scopes', 'desc' => 'Reusable query logic', 'color' => 'green'],
                        ['num' => '05', 'name' => 'Soft Deletes', 'desc' => 'Timestamps & recovery', 'color' => 'orange'],
                        ['num' => '06', 'name' => 'Basic Relationships', 'desc' => 'hasMany, belongsTo', 'color' => 'cyan'],
                        ['num' => '07', 'name' => 'Many-to-Many', 'desc' => 'Pivot tables & sync', 'color' => 'pink'],
                        ['num' => '08', 'name' => 'Polymorphic', 'desc' => 'morphTo & morphMany', 'color' => 'purple'],
                        ['num' => '09', 'name' => 'N+1 Problem', 'desc' => 'Intentionally broken!', 'color' => 'orange'],
                        ['num' => '10', 'name' => 'Eager Loading', 'desc' => 'with(), withCount()', 'color' => 'green'],
                        ['num' => '11', 'name' => 'Complete App', 'desc' => 'All best practices', 'color' => 'yellow'],
                    ];
                @endphp

                @foreach ($branches as $branch)
                    <div class="glass-card p-4 flex items-center gap-4 hover:border-neon-{{ $branch['color'] }} transition-all group">
            ...
            <div class="text-center mt-10">
                <a href="https://github.com/impruthvi/flexboard-bytes" target="_blank" class="btn-neon btn-neon-outline">
                    <span class="flex items-center gap-2">
